...
module.exports = {
    ...
    tags: ["Otto.Blink"],
    params: {
        fast: predef.paramSpecs.period(22),
        slow: predef.paramSpecs.period(36),
        signal: predef.paramSpecs.period(19),
    ...
    plotter: [
        { type: 'multiline', field: ['macd', 'signal', 'zero', 'difference'] },
...
I tried adjusting properties such as relativeWidth, width, and opacity in hopes of simulating square-edged bars by making the lines thicker and reducing gaps between them, but this approach hasn't given me the sharp, square edges I'm looking for.
